...
public class BeingPreparedOrdersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_being_prepared_orders, container, false);

        RecyclerView recyclerViewNewOrders = view.findViewById(R.id.recyclerview_being_prepared_orders);
        ...
        eOrderItemViewModel.getLiveDataPreparingOrderItems()
